<template>
                ...
                <div class="col-md-3">
                    <div class="view-category-box border-color1">
                        <div class="text-center">
                            <p><img src="/images/network.png" alt="icn" width="50px"> Social Business</p>
                        </div>
                    </div>
                </div>
                <div class="col-md-3">
    ...
    <div class="container rs-bft mt-5">
        <div class="view-all-category-bg">
            <div class="row">
                ...
                <div class="view-category-box col-xl-3 col-lg-6 col-md-6 col-sm-6 col-sm-12 " v-for="i in 4" :key="i">
                    <div class="bft_pd">
                        <h4>Name {{i}}</h4>
                        <div class="category-image-box">
                            <img class="lazy" src="/images/ceramic-planters.jpeg" alt="category Image" width="164px" height="140px">
                        </div>
                        <ul>
    ...
    <section class="trigger container rs-bft gutter-horizontal bg-gray gutter-vertical--m gutter-horizontal mt-5">
        ...
        <div class="customer-logos slider" >
           <Carousel>
            <div class="slide-in-right carousel__item" ><img src="/images/SMKW.jpg" alt="Kinderhotel Aschauerhof" height="auto" width="auto"></div>
            <div class="slide-in-right carousel__item" ><img src="/images/Palmetto.jpg" height="auto" width="auto"></div>
            <div class="slide-in-right carousel__item" ><img src="/images/Outdoor.jpg" height="auto" width="auto"></div>
            <div class="slide-in-right carousel__item" ><img src="/images/brownells.jpg" height="auto" width="auto" alt="Loeffele"></div>
            <div class="slide-in-right carousel__item" ><img src="/images/trueShot.jpg" alt="Krone" height="auto" width="auto"></div>
            <div class="slide-in-right carousel__item" ><img src="/images/Global-Ordnance.jpg" alt="Obereggen" height="auto" width="auto"></div>
            <div class="slide-in-right carousel__item" ><img src="/images/basspro.jpg" alt="Ortnerhof" height="auto" width="auto"></div>
            <div class="slide-in-right carousel__item" ><img src="/images/ammo.jpg" alt="Ottonenhof" height="auto" width="auto"></div>
            <div class="slide-in-right carousel__item" ><img src="/images/sportsmansguide.jpg" alt="Leiners" height="auto" width="auto"></div>
            <div class="slide-in-right carousel__item" ><img src="/images/ammunition-depot.jpg" alt="Seitenalm" height="auto" width="auto"></div>
            <div class="slide-in-right carousel__item" ><img src="/images/firearms-depot.jpg" alt="Testerhof" height="auto" width="auto"></div>
            </Carousel>
        </div>
    </section>
    ...
    <div class="latest-blog">
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-6 col-lg-4 col-xl-4" v-for="i in 3" :key="i">
                    <div class="blog-box">
                        <div class="blog-img">
                            <a href=""><img class="img-fluid" src="/images/blog-img.jpg" alt="" /></a>
                        </div>
                        <div class="blog-content">
                            <div class="title-blog">
                                <h3><a href="">Blog {{i}}</a></h3>                               
                            </div>
